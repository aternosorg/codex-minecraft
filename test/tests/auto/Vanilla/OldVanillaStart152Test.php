...
class OldVanillaStart152Test extends PHPUnit\Framework\TestCase
{
    public function testParse()
    {
        ...
        $logFile = new \Aternos\Codex\Log\File\PathLogFile("/home/matthias/Development/aternos/codex-minecraft/test/data/vanilla/old-vanilla-start-152.log");
        $detective = new \Aternos\Codex\Minecraft\Detective\Detective();
        $detective->setLogFile($logFile);
        $log = $detective->detect();
        $log->parse();
        
        $expected = 'Aternos\Codex\Minecraft\Log\OldVanillaLog Object
(
