...
class FabricMissingDependencyVersionedTest extends PHPUnit\Framework\TestCase
{
    public function testParseAndAnalyse()
    {
        date_default_timezone_set('UTC');
        $logFile = new \Aternos\Codex\Log\File\PathLogFile(__DIR__ . "/../../../data/fabric/fabric-missing-dependency-versioned.log");
...
(
    [entries:protected] => Array
        (
            ...
            [1] => Aternos\Codex\Minecraft\Log\Entry Object
                (
                    [prefix:protected] => [18:50:43] [ForkJoinPool-1-worker-3/WARN]:
                    [lines:protected] => Array
                        (
                            [0] => Aternos\Codex\Log\Line Object
                                (
                                    [text:protected] => [18:50:43] [ForkJoinPool-1-worker-3/WARN]: The mod "autoconfig1u" contains invalid entries in its mod json:
                                    [number:protected] => 2
                                )
            ...
            [2] => Aternos\Codex\Minecraft\Log\Entry Object
                (
                    [prefix:protected] => [18:50:43] [main/FATAL]:
                    [lines:protected] => Array
                        (
                            [0] => Aternos\Codex\Log\Line Object
                                (
                                    [text:protected] => [18:50:43] [main/FATAL]: A critical error occurred
                                    [number:protected] => 4
                                )

                            [1] => Aternos\Codex\Log\Line Object
                                (
                                    [text:protected] => net.fabricmc.loader.discovery.ModResolutionException: Could not find required mod: origins requires {fabric @ [1.0.0]}
                                    [number:protected] => 5
                                )
    ...
    [logFile:protected] => Aternos\Codex\Log\File\PathLogFile Object
        (
            [content:protected] => [18:50:43] [main/INFO]: Loading for game Minecraft 1.16.5
[18:50:43] [ForkJoinPool-1-worker-3/WARN]: The mod "autoconfig1u" contains invalid entries in its mod json:
- Unsupported root entry "$schema" at line 2 column 14
[18:50:43] [main/FATAL]: A critical error occurred
net.fabricmc.loader.discovery.ModResolutionException: Could not find required mod: origins requires {fabric @ [1.0.0]}
...
';
        ...
        $this->assertEquals("The mod 'origins' is missing the required mod 'FabricAPI'.", $analysis[1]->getMessage());
        $this->assertEquals("Install the mod 'FabricAPI' with version 1.0.0.", $analysis[1][0]->getMessage());
