...
';
        ...
        $this->assertEquals("The plugin 'FactionsShop' is missing the required plugin 'Vault'.", $analysis[1]->getMessage());
        ...
        $this->assertEquals("The plugin 'BasicTab' is missing the required plugin 'ProtocolLib'.", $analysis[2]->getMessage());
