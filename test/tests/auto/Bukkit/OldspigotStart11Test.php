...
class OldspigotStart11Test extends PHPUnit\Framework\TestCase
{
    public function testParseAndAnalyse()
    {
        date_default_timezone_set('UTC');
        $logFile = new \Aternos\Codex\Log\File\PathLogFile(__DIR__ . "/../../../data/bukkit/oldspigot-start-11.log");
        ...
        $expectedLog = 'Aternos\Codex\Minecraft\Log\OldSpigotLog Object
(
                ...
                (
                    ...
                    [lines:protected] => Array
                        (
                            [0] => Aternos\Codex\Log\Line Object
                                (
                                    [text:protected] => 2019-02-08 23:33:20 [INFO] This server is running CraftBukkit version git-Spigot-1.1-R6-b1988jnks (MC: 1.1) (Implementing API version 1.1-R6)
                                    [number:protected] => 4
                                )
...
2019-02-08 23:33:20 [INFO] This server is running CraftBukkit version git-Spigot-1.1-R6-b1988jnks (MC: 1.1) (Implementing API version 1.1-R6)
